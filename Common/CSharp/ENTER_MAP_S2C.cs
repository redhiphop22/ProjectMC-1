...
public struct ENTER_MAP_S2C : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_2_0_0(); }
  public static ENTER_MAP_S2C GetRootAsENTER_MAP_S2C(ByteBuffer _bb) { return GetRootAsENTER_MAP_S2C(_bb, new ENTER_MAP_S2C()); }
  public static ENTER_MAP_S2C GetRootAsENTER_MAP_S2C(ByteBuffer _bb, ENTER_MAP_S2C obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
